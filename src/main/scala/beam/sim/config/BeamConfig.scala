    ...
    object Agentsim {
      ...
      object ChargingNetworkManager {
        ...
        case class ScaleUp(
          ...
          residentialStallsAvailabilityPerTAZFilePath : java.lang.String
        )
        object ScaleUp {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.ChargingNetworkManager.ScaleUp = {
            BeamConfig.Beam.Agentsim.ChargingNetworkManager.ScaleUp(
              ...
              residentialStallsAvailabilityPerTAZFilePath = if(c.hasPathOrNull("residentialStallsAvailabilityPerTAZFilePath")) c.getString("residentialStallsAvailabilityPerTAZFilePath") else ""
            )
          }
        }
